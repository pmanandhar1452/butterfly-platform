...
export default function LoginScreen() {
  ...
  const handleGoogleSignIn = async () => {
    try {
      setIsLoading(true);
      // Google sign-in will be handled by the GoogleSignInButton component
      // After successful authentication, navigate to main app
      setTimeout(() => {
        setIsLoading(false);
        router.replace('/(tabs)');
      }, 2000);
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.formContainer}>
            ...
            <Text style={styles.subtitleText}>Grow your LinkedIn presence with AI</Text>

            {/* App Description */}
            <View style={styles.descriptionContainer}>
              <Sparkles size={20} color="#0077B5" style={styles.descriptionIcon} />
